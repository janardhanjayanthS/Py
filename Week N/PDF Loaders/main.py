...
def pdf_loader_with_pdfplumber():
    import pdfplumber
...
# 4. Langchain's Pymypdf loader page_content attr of each doc is empty


def pdf_loader_with_langchain_pymupdf():
...
def pdf_loader_with_llm_pymupdf():
    import base64
...
def pdf_loader_with_pymupdf_easyocr():
