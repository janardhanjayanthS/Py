...
```mermaid
graph TD
    A[Choose Instance Type] --> B{What's your workload?}
    B -->|Learning/Testing| C[t2.micro]
    B -->|Web App/API| D[t2.small/t3.small]
    B -->|CPU Intensive| E[c5 family]
    B -->|Memory Intensive| F[r5 family]
```
...
stateDiagram-v2
    ...
    note right of Stopped: Data preserved<br/>Can restart
    note right of Terminated: Data lost<br/>Cannot undo
```
